...
with st.sidebar:
    ...
    st.caption(
        "Choose how you want the model to evaluate the rent vs buy decision."
    )
    ...
    if mode == "Deterministic":
        st.caption(
            "Runs a single, straightforward scenario using the assumptions shown. "
            "Best for understanding the baseline outcome and how different factors interact."
        )
    else:
        st.caption(
            "Explores many plausible futures by allowing key assumptions to vary. "
            "Best for understanding uncertainty, risk, and how often owning or renting comes out ahead."
        )
    ...
    if mode == "Monte Carlo":
        ...
        st.caption(
            "Monte Carlo profiles control how much uncertainty is applied to future assumptions. "
...
# ======================================================
if mode == "Deterministic":
    result = run_deterministic_cached(context, overrides)
...
# ======================================================
    ...
    with st.spinner("Running Monte Carlo simulation..."):
        ...
        det_result = run_deterministic_cached(context, overrides)
